...
def cosine_similarity(u, v):
    ...
    # compute the consine similarity defined
...
if __name__ == "__main__":
    u = np.array([1, 3, 3])
    v = np.array([1, 2, 3])
    cosine_similarity = cosine_similarity(u, v)
    ...
    print(f"cosine_similarity(ball, crocodile) = {cosine_similarity(ball, crocodile)}")
